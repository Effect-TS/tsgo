...
<table>
  ...
  <tbody>
    ...
    <tr><td><a href="https://github.com/Effect-TS/tsgo/blob/main/docs/rules/flat-map-ignored-param-to-and-then.md"><code>flatMapIgnoredParamToAndThen</code></a></td><td>Suggests using Effect.andThen instead of Effect.flatMap when the callback ignores its parameter and returns a pre-existing effect</td></tr>
