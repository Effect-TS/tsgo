...
6. The CLI package dependency on `effect` must use this exact package version target: `4.0.0-beta.101`.
7. The CLI package dependency on `@effect/platform-node` must use this exact package version target: `4.0.0-beta.101`.
